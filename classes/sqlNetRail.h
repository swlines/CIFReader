...
#include <ssqls.h>
	...
	sql_create_54(locations_t, 1, 54,
		mysqlpp::sql_int, id,
		...
		mysqlpp::sql_int, act_a,
		mysqlpp::sql_int, act_ae,
		mysqlpp::sql_int, act_bl,
		mysqlpp::sql_int, act_c,
		mysqlpp::sql_int, act_d,
		mysqlpp::sql_int, act_minusd,
		mysqlpp::sql_int, act_e,
		mysqlpp::sql_int, act_g,
		mysqlpp::sql_int, act_h,
		mysqlpp::sql_int, act_hh,
		mysqlpp::sql_int, act_k,
		mysqlpp::sql_int, act_kc,
		mysqlpp::sql_int, act_ke,
		mysqlpp::sql_int, act_kf,
		mysqlpp::sql_int, act_ks,
		mysqlpp::sql_int, act_l,
		mysqlpp::sql_int, act_n,
		mysqlpp::sql_int, act_op,
		mysqlpp::sql_int, act_or,
		mysqlpp::sql_int, act_pr,
		mysqlpp::sql_int, act_r,
		mysqlpp::sql_int, act_rm,
		mysqlpp::sql_int, act_rr,
		mysqlpp::sql_int, act_s,
		mysqlpp::sql_int, act_t,
		mysqlpp::sql_int, act_minust,
		mysqlpp::sql_int, act_tb,
		mysqlpp::sql_int, act_tf,
		mysqlpp::sql_int, act_ts,
		mysqlpp::sql_int, act_tw,
		mysqlpp::sql_int, act_u,
		mysqlpp::sql_int, act_minusu,
		mysqlpp::sql_int, act_w,
		mysqlpp::sql_int, act_x)
